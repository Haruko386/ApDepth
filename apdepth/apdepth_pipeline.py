...
class ApDepthDepthOutput(BaseOutput):
    """
    Output class for ApDepth monocular depth prediction pipeline.
...
class ApDepthPipeline(DiffusionPipeline):
    """
    Pipeline for monocular depth estimation using ApDepth: https://haruko386.github.io/research.
    ...
    def __init__(
        ...
        if da2_config is not None:
            ...
            print(f"DepthAnything v2 ({da2_config['encoder']}) loaded for ApDepth Pipeline.")
        else:
            self.da2 = None
