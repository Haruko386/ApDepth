...
class TED(nn.Module):
    ...
    def forward(self, x):
        ...
        # Add this section to save the image
        try:
            ...
            # You may need to normalize or process the 'out' tensor first.
            for i in range(out.shape[0]):
                save_image(out[i], os.path.join(save_dir, f"enhanced_image_{i}.png"))
            print(f"Image successfully saved to {output_path}")

        except ImportError:
            print("torchvision not found. Cannot save image.")
